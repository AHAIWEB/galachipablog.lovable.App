...
import { newsCategories, blogCategories, directoryCategories, type CategoryItem } from "@/data/categories";

type MenuType = "news" | "blog" | "directory" | null;

const menuConfig = {
  news: { label: "📰 জনপদ ও খবর", categories: newsCategories, colorClass: "mega-menu-letter-news", placeholder: "খবর খুঁজুন..." },
  blog: { label: "💡 মনন ও ব্লগ", categories: blogCategories, colorClass: "mega-menu-letter-blog", placeholder: "ব্লগ খুঁজুন..." },
  directory: { label: "📂 ইনডেক্স ও ডিরেক্টরি", categories: directoryCategories, colorClass: "mega-menu-letter-directory", placeholder: "ডিরেক্টরি খুঁজুন..." },
};
